...
int main() {
    FILE *file_ptr;
    file_ptr = fopen("C:\\Users\\jolsz\\uni\\freshman\\CT103 - Programming\\assignments\\Assignment22_JakubOlszewski_23710521\\article-irish-times.txt", "r"); // open for reading
    if (file_ptr == NULL) {
